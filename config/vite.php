    ...
    */
    'configs'      => [
        ...
        'candidate-management' => [
            'entrypoints' => [
                'paths' => 'src/CandidateManagement/resources/scripts/main.ts',
            ],
            'dev_server'  => [
                'url'          => env('DEV_SERVER_URL', 'http://localhost:3000'),
                'ping_timeout' => 1
            ],
            'build_path'  => 'build/candidate-management',
        ],

        'candidate-pool' => [
            'entrypoints' => [
                'paths' => 'src/CandidatePool/resources/scripts/main.ts',
            ],
            'dev_server'  => [
                'url'          => env('DEV_SERVER_URL', 'http://localhost:3000'),
                'ping_timeout' => 1000
            ],
            'build_path'  => 'build/candidate-pool',
        ]
    ],
